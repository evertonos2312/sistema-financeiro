<form class="mr-auto" method="post" id="filtroForm" action="{$action}">
	...
	{if $generic_filter}
		...
		{if !empty($filters)}
		<button class="btn btn-outline-success btn-rounded" type="button" data-toggle="modal" data-target="#filtroFormAdvancedModal"><i class="fas fa-search"></i> Busca Avançada {if $icon_filter_advanced}<i class="far fa-times-circle"></i>{/if}</button>
		{/if}
	{/if}
		  ...
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
			  <div class="modal-header">
				<h5 class="modal-title" id="filtroFormAdvancedModalTitle">Filtro Avançado</h5>
